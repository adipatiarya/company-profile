          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-12 col-md-auto">
		            <a className="btn btn-cta-primary" href="https://wa.link/uoo7d2" target="_blank"><i className="fas fa-paper-plane"></i> Kontak Saya</a>        
              </div>
            </div>
          </div>
        </header>
            ...
            <div className="primary col-lg-8 col-12">
                ...
                <div className="section-inner shadow-sm rounded">
                  ...
                  <div className="content">
                    <div className="item featured text-center">
                      ...
                      <h3 className="title mb-3"><a href="#" target="_blank">Launch - The perfect Bootstrap template for SaaS products</a></h3>
                      ...
                      <a className="btn btn-cta-secondary" href="#" target="_blank"><i className="fas fa-thumbs-up"></i> Back my project</a> 
                    </div>
              ...
              <section className="github section">
                <div className="section-inner shadow-sm rounded">
                  ...
                  <p>You can embed your GitHub contribution graph calendar using IonicaBizau's <a href="#" target="_blank">GitHub Calendar</a> widget. </p>
              ...
              <aside className="education aside section">
                ...
                <aside className="list conferences aside section">
                    <div className="section-inner shadow-sm rounded">
                        ...
                        <div className="content">
                            <ul className="list-unstyled">
                                <li><i className="far fa-calendar-alt"></i> <a href="#" target="_blank">WWDC 2030</a> (San Francisco)</li>
                    ...
                    <div className="section-inner shadow-sm rounded">
                        ...
                        <div className="content">
                            <ul className="list-unstyled pb-2">
                                <li><a href="#" target="_blank"><i className="fas fa-external-link-alt"></i>Bootstrap</a></li>
                                <li><a href="#" target="_blank"><i className="fas fa-external-link-alt"></i>FontAwesome</a></li>
                                <li><a href="#" target="_blank"><i className="fas fa-external-link-alt"></i>GitHub Calendar Plugin</a></li>
                                
                                <li><a href="#" target="_blank"><i className="fas fa-external-link-alt"></i>GitHub Activity Stream</a></li>
                                
                                <li><a href="#" target="_blank"><i className="fas fa-external-link-alt"></i>Vanilla RSS</a></li>
                            ...
                            <hr/>
                             ...
                             <p className="pt-2">This Boootstrap portfolio template is handcrafted by UX designer <a href="https://twitter.com/3rdwave_themes" target="_blank">Xiaoying Riley</a> at <a href="#" target="_blank">3rd Wave Media</a> for developers and is <strong>FREE</strong> as long as you keep the footer attribution link.</p>
                             <p>If you’d like to <strong>use this template without the attribution link</strong>, you can <a href="#" target="_blank">buy the commercial license</a>.</p>
                             
                             <a className="btn btn-cta-primary btn-download" href="#" target="_blank"><i className="fas fa-download"></i> I want to download</a>
                            <hr/>
                            ...
                            <p>Follow <a href="#" target="_blank">Xiaoying</a> on twitter so you don't miss any future freebies!</p> 
                            
                            <a className="btn btn-cta-secondary btn-follow" href="#" target="_blank"><i className="fab fa-twitter"></i> Follow on twitter</a>
